...
_type_ | flespi
_info_ | requires signup/username, [information page](https://flespi.com/mqtt-broker), free to use up to [100 persistent sessions](https://flespi.com/pricing#restrictions), [REST API](https://flespi.com/mqtt)
